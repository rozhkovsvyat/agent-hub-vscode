...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close Cukii Sidebar If Chat Already In Focus",
  },
  {
    shortcut: "esc",
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Cukii Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Cukii"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
