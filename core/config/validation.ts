  ...
  if (config.tabAutocompleteModel) {
    function validateTabAutocompleteModel(modelDescription: ModelDescription) {
      ...
      if (
        ...
        errors.push({
          fatal: false,
          message: `${modelDescription.model} is not trained for tab-autocomplete, and will result in low-quality suggestions. See the project repository to learn more about why: https://github.com/rozhkovsvyat/agent-hub-vscode`,
        });
      }
    }
